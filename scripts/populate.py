...
'''   populate tables mousiko_organo OK,
                        athlima,OK
                        ΠΕΡΙΟΧΗ, OK
                        smeae kathgoria
...
from db import Base, Klados, Real_eidikothta, Pinakas, Sxoliko_etos, Hmeromhnia,\
Kathgoria, Smeae_pinakas, Smeae_kathgoria, Perioxh, Mousiko_organo, Athlima,\
